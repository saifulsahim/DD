...
<div class="box">
    <div class="box-header">
        <h2 class="box-title">Active List- Expenses</h2>
    </div>
    <!-- /.box-header -->
    <div class="box-body">
            ...
            <tr>
               <!-- <td><input type='checkbox' class='checkbox' name='multiple[]' value='$record->id'></td>-->
                ...
                <td>
                 ...
                 <a href='admin_master.php?page=view_expense_category&id=$record->id' class='btn btn-primary btn-sm'>View</a>
                  <a href='admin_master.php?page=edit_expense_category&id=$record->id' class='btn btn-warning btn-sm'>Edit</a>
<!--                  <a href='trash.php?id=$record->id' class='btn btn-success btn-sm'>Trash</a>-->
                    <a href='admin_master.php?page=delete_expense_category&id=$record->id' class='btn btn-danger btn-sm' onclick='return confirm_delete()'>Delete</a>
