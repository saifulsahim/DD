...
<ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            <li><a href="admin_master.php?page=add_sub_test_category"><i class="fa fa-circle-o"></i>Add Category</a>
            </li>
            <li><a href="admin_master.php?page=manage_sub_test_category"><i class="fa fa-circle-o"></i> Manage Category</a>
            </li>
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            ...
            <li><a href="admin_master.php?page=manage_doctor_category"><i class="fa fa-circle-o"></i> Manage Doctor </a>
            </li>
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            <li><a href="admin_master.php?page=add_expense_category"><i class="fa fa-circle-o"></i> Add Expense Category</a>
            </li>
            <li><a href="admin_master.php?page=manage_expense_category"><i class="fa fa-circle-o"></i> Manage Expense
                    Category</a>
            </li>
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            ...
            <li><a href="admin_master.php?page=manage_invoice"><i class="fa fa-circle-o"></i> Manage Test Invoice</a>
            </li>
        </ul>
    </li>
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            ...
            <li><a href="admin_master.php?page=add_custom_invoice"><i class="fa fa-circle-o"></i> Custom Invoice</a>
            </li>
            <li><a href="admin_master.php?page=add_custom_doctor_invoice"><i class="fa fa-circle-o"></i> Custom Doctor
                    Invoice</a></li>
        </ul>
    </li>
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            ...
            <li><a href="admin_master.php?page=add_expense_report"><i class="fa fa-circle-o"></i> Expense Report</a>
            </li>
